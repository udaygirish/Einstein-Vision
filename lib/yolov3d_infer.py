...
def detect3d(
    ...
    # Directory
    imgs_path = source #sorted(glob.glob(str(source) + '/*')) # List of image files for now 
    ...
    for i, img_path in enumerate(imgs_path):
        ...
        for det in dets:
            ...
            Out_Objects.append({"Location": loc, "Dim" : dim.tolist(), "Orientation" : orient.tolist() ,"Corners": corners, "R": R.tolist(), "Center": center, "Box_3d": box_3d, "Class": detected_class, "Box_2d": det.box_2d})
