YOLOCLASSES_TO_BLENDER = {
    ...
    'truck':'Truck',
    'hump':'SpeedHump',
    'carRed':'CarRed', # Car_Red
    'truckRed':'TruckRed', # Truck_Red
    'pickupTruckRed':'PickupTruckRed',  # PickupTruck_Red
    'suvRed':'Jeep_3Red',  # Jeep3Red
...
Blender_rot_scale = {
    ...
    'speed limit sign' : {'orientation': (0,0,0) , 'scale' : (.6,.6,.6)},
    ...
    'hump' : {'orientation': (0,1.57,0) , 'scale' : (.2,.2,.15)}, # Done
    ...
    'suvRed' : {'orientation': (0,0,3.14) , 'scale' : (2.5,2.5,2.5)}, # Done
}
